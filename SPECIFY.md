...
除非另有说明，使用Apache许可证2.0版本(“许可证”)授权;除非符合许可证规定，否则您不能使用此文件。
您可以在以下网址获得许可证的副本http://www.apache.org/licenses/LICENSE-2.0
或者你可以查看当前项目下的LICENSE文件(Apache License, Version 2.0的原文件)

除非适用法律要求或书面同意，否则所有材料必须在许可下基于“现状”发布的。
对于使用材料而产生的不良影响，概不负责。
请仔细参阅许可证，了解在许可证下明确的权利与限制。
```
